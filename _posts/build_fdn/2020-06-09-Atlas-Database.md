...
<img src="/assets/images/Atlas_Project_Access.png" style="border:1px solid black" width="100%" alt="Click Access Manager, then Organization Access:"><BR><BR>
...
<img src="/assets/images/Atlas_Access_Permissions.png" style="border:1px solid black" width="100%" alt=" Give yourself the following permissions"><BR><BR>

1. Create a 4.4 Cluster:
   1. Click "Projects" on the left-hand navigation menu<BR>
<img src="/assets/images/Projects.png" style="border:1px solid black" width="50%" alt=" Click 'Projects' on the left-hand navigation menu"><BR><BR>
   1. Click your project name (example: WildAid)
   1. Click Build a Cluster
   1. Choose a path - choose the FREE Shared Clusters on the left: 
<img src="/assets/images/Atlas_Choose_Path.png" style="border:1px solid black" width="100%" alt=" Choose a path - choose the FREE Shared Clusters on the left:"><BR><BR>
   1. Choose Cloud Provider and Region
<img src="/assets/images/Atlas_Cloud_Region.png" style="border:1px solid black" width="100%" alt=" Choose Cloud Provider and Region"><BR><BR>
   1. Choose Cluster Tier - choose M0, the free tier
<img src="/assets/images/Atlas_Tier.png" style="border:1px solid black" width="100%" alt="Choose Cluster Tier - choose M0, the free tier"><BR><BR>
   1. Select a Version - MongoDB 4.4
<img src="/assets/images/Atlas_Version.png" style="border:1px solid black" width="100%" alt="Select a Version - MongoDB 4.4"><BR><BR>
   1. Cluster Name (example: OFISH) - write this in template under "Atlas Cluster Name" 
<img src="/assets/images/Atlas_Cluster_Name.png" style="border:1px solid black" width="100%" alt="Cluster Name (example: OFISH) - write this in template under 'Atlas Cluster Name'" ><BR><BR>
