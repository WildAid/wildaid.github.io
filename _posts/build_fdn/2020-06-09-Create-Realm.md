...
<img src="/assets/images/Click_Realm.png" style="border:1px solid black" width="100%" alt="Click Realm"><BR><BR>
   1. If you get a screen that looks like this, click "Skip questions and start new app", otherwise skip to the next step<BR>
<img src="/assets/images/Skip.png" style="border:1px solid black" width="70%" alt="Skip questions and start new app has been clicked"><BR><BR>
...
<img src="/assets/images/Realm_Config.png" style="border:1px solid black" width="100%" alt="Enter your name of application"><BR><BR>
...
<img src="/assets/images/Copy_Realm_App_ID.png" style="border:1px solid black" width="100%" alt="Click copy icon and copy your Realme id"><BR><BR>
