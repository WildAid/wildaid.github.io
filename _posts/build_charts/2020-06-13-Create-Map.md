...
1. Set the coordinates. <BR>
If location is a number, drag "location" to Coordinates:<BR>
<img src="/assets/images/DragLocation.png" style="border:1px solid black" width="70%"><BR><BR>
<!-- If location is an array, drag "latitude" and "longitude" to Coordinates:<BR>
<img src="/assets/images/DragLatLon.png" style="border:1px solid black" width="70%"><BR><BR> -->
